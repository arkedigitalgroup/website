...
export default function AdminLayout({ children }) {
    ...
    const menuItems = [
        {
            name: lang === "am" ? "አጠቃላይ እይታ" : "Overview",
            path: "/admin",
            icon: "📊",
        },
        {
            name: lang === "am" ? "ተማሪዎች" : "Students",
            path: "/admin/students",
            icon: "👶",
        },
        {
            name: lang === "am" ? "መምህራን ማረጋገጫ" : "Teachers Verification",
            path: "/admin/teachers",
            icon: "👨‍🏫",
        },
        {
            name: lang === "am" ? "መምህር መድብ" : "Matching Center",
            path: "/admin/matching",
            icon: "🗺️",
        },
        {
            name: lang === "am" ? "ፋይናንስ" : "Financials",
            path: "/admin/finances",
            icon: "💼",
        },
        {
