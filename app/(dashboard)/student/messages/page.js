// app/(dashboard)/student/messages/page.js
"use client";
    ...
    const handleSendMessage = async (e) => {
        ...
        try {
            await addDoc(collection(db, "supportMessages"), {
                senderId: user.uid,
                senderName: profile?.fullName || "Student/Parent",
                senderRole: "student",
            ...
            setError(
                lang === "am" ? "መልዕክት መላክ አልተሳካም።" : "Failed to send message.",
            );
        } finally {
            setSending(false);
        }
        ...
        <div className="space-y-6 max-w-4xl mx-auto">
            ...
            <div className="bg-navy-surface border border-navy-border rounded-xl shadow-lg overflow-hidden flex flex-col h-[500px]">
                ...
                <form
                    ...
                    className="p-4 border-t border-navy-border bg-navy-mid/50 flex gap-3"
                >
                    <input
                        type="text"
                        required
